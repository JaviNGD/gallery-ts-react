...
export const Navbar = ():JSX.Element => {
    return (
        <nav className="flex justify-between items-center fixed z-10 top-0 w-full py-5 px-8 bg-white sm:bg-transparent" dir="rtl">
            <ul className="flex items-center gap-4">
                <li className="text-xl md:text-3xl lg:text-4xl">
